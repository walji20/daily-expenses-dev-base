...
private void fillData(Uri uri) {
	...
	String[] projection = { RecordsTable.COLUMN_ID,
							...
							RecordsTable.COLUMN_AMOUNT,
							RecordsTable.COLUMN_BOOKING_TYPE,
							RecordsTable.COLUMN_PERIOD_TYPE,
							RecordsTable.COLUMN_CATEGORY_TYPE,
							RecordsTable.COLUMN_UNIX_DATE,
	...
	if (cursor != null) {
		...
		if(cursor.getInt(cursor.getColumnIndexOrThrow(RecordsTable.COLUMN_DESCRIPTION)) == 1) {
