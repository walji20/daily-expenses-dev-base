 ...
 * {@link RecordListFragment} and the item details
 * (if present) is a {@link RecordDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link RecordListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class RecordListActivity extends SherlockFragmentActivity
        implements RecordListFragment.Callbacks {
   ...
   private static final int DELETE_ID = Menu.FIRST + 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.item_detail_container) != null) {
            ...
            ((RecordListFragment) getSupportFragmentManager()
                    .findFragmentById(R.id.record_list))
	...
	/**
     * Callback method from {@link RecordListFragment.Callbacks}
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.item_detail_container, recordDetailFragment)
                    .commit();
